...
import { ArrowUpRight, Lock, Mail, Eye, EyeOff, ShieldCheck, AlertCircle, Sparkles } from "lucide-react";
      ...
      <div className="w-full max-w-md bg-white/90 backdrop-blur-2xl rounded-[28px] sm:rounded-[36px] p-6 sm:p-10 shadow-[0_20px_50px_-15px_rgba(12,13,17,0.05)] border border-white/90 ring-1 ring-black/[0.03]">
        ...
        <div className="text-center space-y-2 pb-5 border-b border-black/[0.05]">
          ...
          <span className="inline-flex items-center gap-1 px-3 py-1 rounded-full text-[9px] font-mono font-bold uppercase tracking-widest bg-blue-50 text-[#3B7BF6] border border-blue-100/60">
            <Sparkles className="w-2.5 h-2.5" /> Atelier Protocol
          </span>
          ...
          <div className="space-y-1.5">
            <div className="flex items-center justify-between">
              ...
              <Link
                ...
                className="text-[10px] font-mono font-bold uppercase tracking-wider text-[#8E92A2] hover:text-[#0C0D11] transition-colors"
              >
                Forgot?
              </Link>
            </div>
            <div className="relative">
              <input
                ...
                placeholder="••••••••"
                className="w-full pl-10 pr-10 py-3 sm:py-3.5 rounded-2xl bg-[#FAFAFC] focus:bg-white border border-black/[0.07] focus:border-[#0C0D11] text-xs text-[#0C0D11] outline-none transition-all placeholder:text-[#8E92A2]"
              />
              <Lock className="w-4 h-4 text-[#8E92A2] absolute left-3.5 top-1/2 -translate-y-1/2" />
              <button
                type="button"
                onClick={() => setShowPassword(!showPassword)}
                className="absolute right-3.5 top-1/2 -translate-y-1/2 text-[#8E92A2] hover:text-[#0C0D11] transition-colors cursor-pointer"
